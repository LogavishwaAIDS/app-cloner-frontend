    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="row" style={{marginTop:12}}>
          <button onClick={handleClone} disabled={loading}>{loading ? "Cloning..." : "Start Clone"}</button>
        ...
        {preview && (
          <div style={{marginTop:12}}>
            ...
            <div style={{marginTop:8}}>
              <button onClick={()=>window.open(preview, "_blank")}>Open Preview</button>
            </div>
          </div>
        )}
      </div>
      ...
      <footer style={{marginTop:20}}>
        <small>Backend must be running at http://localhost:5000</small>
      </footer>
    </div>
  );
}
